import {
  ...
  export const ModalLoginHeader = ({ bg, w, borderRadius, h, text }: PropsStyle) => {
    ...
    return (
      <>
        <Button bg="rgba(43, 41, 69, 1)" color="#fff" onClick={onOpen} p="0px" w={["100px","100px","150px"]} h={["30px","30px","30px"]}>
        Entrar
      </Button>
